...
- (void)addDemoItemViews
{
    ...
    //Custom
    //[self.demoViews addObject:[SDDemoItemView demoItemViewWithClass:[CustomCircleProgressView class]]];
    [self.demoViews addObject:[SDDemoItemView demoItemViewWithClass:[CustomPieProgressView class]]];
}
